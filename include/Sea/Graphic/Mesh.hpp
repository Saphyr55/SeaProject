...
namespace Sea
{
	...
	public:
		...
		inline std::vector<Mold<Texture2D>> GetTextures() { return m_textures; }
		inline std::vector<u32> GetIndices() { return m_indices; }
		inline std::vector<Vertex> GetVertices() { return m_vertices; }

		Mesh(std::vector<Vertex>& vertices, std::vector<u32>& indices, std::vector<Mold<Texture2D>>& textures);
	...
	protected:
		...
		std::vector<Mold<Texture2D>> m_textures;
	};
}
